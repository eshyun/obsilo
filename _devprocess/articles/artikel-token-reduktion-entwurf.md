...
### Episodes, recipes, long-term memory
...
| Prompt reordering | ~90% cache hit on system prompt | Saves per remaining iteration |
| Externalization | Tool results -80% in history | Condensing needed less often |
